...
export default function Hero() {
  return (
    <section className="min-h-screen flex justify-around items-center bg-gray-900 text-white text-center px-4">
      <div className="flex flex-col items-start w-auto">
        <a
          href="#contact"
          className="px-6 py-3 text-black bg-white mb-1 rounded-xl font-medium shadow-lg transition-all"
        >
